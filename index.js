...
var options = {
  method: "GET",
  url: "https://botapi.gadu-gadu.pl/botmaster/getToken/75245214",
  headers: {
...
app.post("/sendMessage/:number", async (req, res) => {
  ...
  let messageOptions = {
    method: "POST",
    url: "https://botapi-10.gadu-gadu.pl/sendMessage/75245214",
    headers: {
...
app.get("/botgg87705b52.html", (req, res) => {
  res.sendFile(path.join(__dirname + "/verification/botgg87705b52.html"));
});
